...
public class SPI {
     ...
     * @param endianness whether data is sent with the first- or least-significant bit first (SPI.MSBFIRST or SPI.LSBFIRST, the former is more common)
