...
while [[ "${EXIT}" == "false" ]]; do
  ...
  echo -e "+-------------------------------+--------------------------------+"
  echo -e "|  1: Led Counter               |  2: Push Button input          |"
  echo -e "|  3: MCP3008 (ADC)             |  4: OLED SSD1306               |"
  echo -e "|  5: GPIO Interrupt            |  6: BMP180 (I2C env sensor)    |"
  echo -e "|  7: BME280 (I2C env sensor)   |  8: Servo (Direct GPIO)        |"
  echo -e "|  9: ADS1015 (I2C ADC)         | 10: PCA9685 (I2C Servos)       |"
  echo -e "| 11: STH10 (Pure GPIO)         | 12: VL53L0X (I2C ToF)          |"
  echo -e "| 13: TSL2561 (I2C LightSensor) | 14: HC_SR04 (GPIO RangeSensor) |"
  echo -e "| 15: GPIO Led/Relay flip       |                                |"
  echo -e "+-------------------------------+--------------------------------+"
